...
- **Child ticket**: an issue linked to the map as a GitHub sub-issue. Where sub-issues aren't enabled, add it to a task list in the map and put `Part of #<map>` in the child body.
